...
class NceaBot(MDApp):
    ...
    def fetch_results(self,):
       global driver
       if driver.current_tab == "https://secure.nzqa.govt.nz/for-learners/records/my-entries-results.do":
    ...
    def save_prompt(self):
        ...
        prompt = f"{new_prompt}\n{text_content} rule:this is a rule i have set answer everthing in short words 50 max"
